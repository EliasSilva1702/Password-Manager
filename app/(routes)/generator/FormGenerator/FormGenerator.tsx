...
export function FormGenerator() {
  ...
  useEffect(() => {
    if (selectedValue === "user") {
      const newUserGenerated = generateRandomUser(8);
  ...
  return (
    <div className="mt-5 max-w-2xl">
      ...
      <div className="bg-slate-100 rounded-md shadow-md p-4 my-4">
        <p className="mb-4 text-slate-500">What would you like to generate?</p>
        <RadioGroup
